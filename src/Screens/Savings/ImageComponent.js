...
import {add_to_delete_list, change_selected_to_delete_count, remove_from_delete_list} from "../../Store/Actions";
            ...
            <View>
                <TouchableOpacity
                    ...
                    <ImageBackground source={{uri: image.uri}} style={style}>
                        <View display={deleteMode && will_be_deleted ? 'flex' : 'none'} style={styles.deleteStyle}>
...
const mapDispatchToProps = dispatch => {
    return {
        change_selected_to_delete_count: (bool) => dispatch(change_selected_to_delete_count(bool)),
