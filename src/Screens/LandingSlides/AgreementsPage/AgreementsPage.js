...
class AgreementsPage extends Component {
    ...
    SeeWebViewPage = (index) => {
        if (index === 0)
            this.props.navigation.navigate("WebViewPage", {url: "https://app-fab.com/apps/hik-demis/kvkk.html"});
        else if (index === 1)
            this.props.navigation.navigate("WebViewPage", {url: "https://app-fab.com/apps/hik-demis/privacy-policy.html"});
    }
    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.mainContainerStyle}>
                ...
                <Button title={translate("continue")} onPress={() => this.Continue()}
