...
class ResultPageBody extends Component {
  ...
  componentWillMount = async () => {
    ...
    grave_flex = typeof celebrity.dead !== 'undefined' && celebrity.dead !== null && celebrity.dead;
    age = typeof (celebrity.age !== 'undefined' && celebrity.age !== null) ? celebrity.age : "";
    birthday = typeof (celebrity.birthday !== 'undefined' && celebrity.birthday !== null) ? celebrity.birthday : "";
    name = typeof (celebrity.name !== 'undefined' && celebrity.name !== null) ? celebrity.name : "";
    photo = typeof (celebrity.photo !== 'undefined' && celebrity.photo !== null) ? celebrity.photo : "";

    try {
      similarity = typeof (data.similarity !== 'undefined' && data.similarity !== null) ? data.similarity : "";
    } catch (e) {
    ...
    try {
      nationality = typeof (celebrity.nationality.name !== 'undefined' && celebrity.nationality.name !== null) ? celebrity.nationality.name : "";
    } catch (e) {
      console.log("Error componentWillMount: ", e);
      nationality = "";
    }
    ...
    try {
      category = typeof (celebrity.category.name !== 'undefined' && celebrity.category.name !== null) ? celebrity.category.name : "";
    } catch (e) {
      category = "";
    }

    try {
      star_sign = typeof (celebrity.star_sign.name !== 'undefined' && celebrity.star_sign.name !== null) ? celebrity.star_sign.name : "";
    } catch (e) {
      star_sign = "";
    }
