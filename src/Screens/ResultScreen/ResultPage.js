    ...
    SavePicture = async (uri) => {
        ...
        CameraRoll.save(uri, saveToCameraRollOptions)
            .then(async (res) => {
                ...
                Alert.alert(translate("result.result_saved"), '', [
                    {text: translate("result.okay"), onPress: () => this.actionSheet.hide(), style: 'cancel'},
                ], {cancelable: false});
            }).catch(err => {
            console.log("err: ", err);
            this.actionSheet.hide();
                    ...
                    [
                        translate("image_picker.cancel"),
                        {
                            component: <TouchableOpacity style={styles.line_container_style}
                                ...
                                <Text
                                    style={styles.modal_text_style}>{translate("image_picker.save_result")}</Text>
                            </TouchableOpacity>,
                            height: 65,
                        },
                        {
                            component: <TouchableOpacity style={styles.line_container_style}
                                ...
                                <Text
                                    style={styles.modal_text_style}>{translate("image_picker.share_result")}</Text>
                            </TouchableOpacity>,
                            height: 65,
                        },
                        {
                            component: <TouchableOpacity style={styles.line_container_style}
                                ...
                                <Text style={styles.modal_text_style}>{translate("image_picker.share_app")}</Text>
                            </TouchableOpacity>,
                            height: 65,
                        }
                    ]
